...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discussion_question', (
        ...
        db.send_create_signal('discussion', ['Question'])

        # Adding model 'Response'
        db.create_table('discussion_response', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', to=orm['discussion.Question'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('discussion', ['Response'])


    def backwards(self, orm):
        
        # Deleting model 'Question'
        db.delete_table('discussion_question')

        # Deleting model 'Response'
        db.delete_table('discussion_response')
    ...
    models = {
        ...
        'discussion.response': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'responses'", 'to': "orm['discussion.Question']"}),
            'score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
