...
class Question(models.Model):
    ...
    question = models.CharField(_("title"), max_length=100)
    ...
    def get_absolute_url(self):
        ...
        return reverse_func("discussion_question_detail", kwargs=kwargs)
...
class Response(models.Model):
    ...
    def accept(self):
        ...
        try:
            response = Response.objects.get(question=self.question,
                                            accepted=True)
        except Response.DoesNotExist:
            pass
        else:
